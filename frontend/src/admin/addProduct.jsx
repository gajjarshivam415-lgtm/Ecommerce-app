  ...
  return (
    <div className="w-screen h-screen flex justify-center items-center bg-gray-200">
      <div className="w-1/4 bg-white p-8 rounded-lg shadow-lg  flex flex-col items-center space-y-7">
        <h2 className="text-3xl font-semibold text-cyan-700 py-5">Add New Product</h2>
        <form
        ...
        >
          ...
          <button type="submit" className="bg-cyan-500 px-7 py-2 my-5 font-medium text-2xl rounded-2xl active:scale-103">Add Product</button>
        </form>
      </div>
    </div>
  );
